...
\echo
Use "CREATE EXTENSION url"
to load this file. \quit

CREATE OR REPLACE FUNCTION url_in
(cstring)
    RETURNS pg_url
    AS '$libdir/url', 'url_in'
    LANGUAGE C IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION url_out
(pg_url)
    RETURNS cstring
...
-- getPort(url)
CREATE OR REPLACE FUNCTION get_port
(pg_url)
RETURNS int
...
-- getProtocol(url)
CREATE OR REPLACE FUNCTION get_protocol
(pg_url)
RETURNS cstring
...
-- getDefaultPort(url)
CREATE OR REPLACE FUNCTION get_default_port
(pg_url)
RETURNS int
...
-- toString(url)
CREATE OR REPLACE FUNCTION toString
(pg_url)
RETURNS cstring
...
CREATE OR REPLACE FUNCTION pg_url_equals_internal
(pg_url, pg_url) 
RETURNS boolean
...
-- notEquals(url1, url2)
CREATE OR REPLACE FUNCTION pg_not_equals
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION same_file_internal
(pg_url, pg_url)
RETURNS boolean
...
-- lessThan(url1, url2)
CREATE OR REPLACE FUNCTION pg_url_less_than
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION pg_url_less_than_or_equal
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION pg_url_greater_than
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION pg_url_greater_than_or_equal
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION pg_url_cmp
(pg_url, pg_url)
RETURNS int
...
CREATE OR REPLACE FUNCTION same_host_internal
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION different_host
(pg_url, pg_url)
RETURNS boolean
...
COMMENT ON OPERATOR <>
(pg_url, pg_url) IS 'hosts not equal?';
...
CREATE OR REPLACE FUNCTION same_host
(pg_url, pg_url)
RETURNS boolean
AS 'SELECT $1 = $2'
...
CREATE OR REPLACE FUNCTION same_file
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION pg_url_equals
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION pg_url_less_than_host
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION pg_url_less_than_or_equal_host
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION pg_url_greater_than_host
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION pg_url_greater_than_or_equal_host
(pg_url, pg_url)
RETURNS boolean
...
CREATE OR REPLACE FUNCTION pg_url_cmp_host
(pg_url, pg_url)
RETURNS int
...
COMMENT ON OPERATOR <
(pg_url, pg_url) IS 'less than host?';
...
COMMENT ON OPERATOR <=
(pg_url, pg_url) IS 'less than or equal host?';
...
COMMENT ON OPERATOR >
(pg_url, pg_url) IS 'greater than host?';
...
COMMENT ON OPERATOR >=
(pg_url, pg_url) IS 'greater than or equal host?';
