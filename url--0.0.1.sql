...
CREATE FUNCTION pg_url(pg_url, cstring)
RETURNS pg_url
...
-- getUserInfo(url)
CREATE FUNCTION get_userinfo(pg_url)
RETURNS cstring
...
-- getAuthority(url)
CREATE FUNCTION get_authority(pg_url)
RETURNS cstring
...
-- getDefaultPort(url)
CREATE FUNCTION get_default_port(pg_url)
RETURNS int
...
-- getPath(url)
CREATE FUNCTION get_path(pg_url)
RETURNS cstring
AS '$libdir/url', 'get_path'
LANGUAGE C IMMUTABLE STRICT;

-- getQuery(url)
CREATE FUNCTION get_query(pg_url)
RETURNS cstring
AS '$libdir/url', 'get_query'
LANGUAGE C IMMUTABLE STRICT;

-- getRef(url)
CREATE FUNCTION get_ref(pg_url)
RETURNS cstring
...
CREATE FUNCTION pg_url_equals_internal(pg_url, pg_url) 
RETURNS boolean
...
CREATE FUNCTION same_file_internal(pg_url, pg_url)
RETURNS boolean
AS '$libdir/url', 'same_file'
LANGUAGE C IMMUTABLE STRICT;

-- lessThan(url1, url2)
CREATE FUNCTION pg_url_less_than(pg_url, pg_url)
RETURNS boolean
AS '$libdir/url', 'less_than'
LANGUAGE C IMMUTABLE STRICT;

-- lessThanOrEqual(url1, url2)
CREATE FUNCTION pg_url_less_than_or_equal(pg_url, pg_url)
RETURNS boolean
AS '$libdir/url', 'less_than_or_equal'
LANGUAGE C IMMUTABLE STRICT;

-- greaterThan(url1, url2)
CREATE FUNCTION pg_url_greater_than(pg_url, pg_url)
RETURNS boolean
AS '$libdir/url', 'greater_than'
LANGUAGE C IMMUTABLE STRICT;

-- greaterThanOrEqual(url1, url2)
CREATE FUNCTION pg_url_greater_than_or_equal(pg_url, pg_url)
RETURNS boolean
AS '$libdir/url', 'greater_than_or_equal'
LANGUAGE C IMMUTABLE STRICT;

-- urlCompare(url1, url2)
CREATE FUNCTION pg_url_cmp(pg_url, pg_url)
RETURNS int
...
CREATE FUNCTION same_host_internal(pg_url, pg_url)
RETURNS boolean
AS '$libdir/url', 'same_host_internal'
LANGUAGE C IMMUTABLE STRICT;

-- differentHost(url1, url2)
CREATE FUNCTION different_host(pg_url, pg_url)
RETURNS boolean
...
CREATE FUNCTION same_host(pg_url, pg_url)
RETURNS boolean
AS 'SELECT $1 = $2'
...
CREATE FUNCTION same_file(pg_url, pg_url)
RETURNS boolean
